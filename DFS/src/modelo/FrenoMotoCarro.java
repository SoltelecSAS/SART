 ...
 * @author SOLTELEC
 */
public class FrenoMotoCarro implements PruebaDefault {
   ...
   private List<Double> pesoDerecho;
    ...
    //de frenos.
    public static final double EFICACIA_FRENADO_A = 30; //
    ...
    public FrenoMotoCarro(float factorDesq) {
 ...
 @Override
    ...
    public List<Integer> getTiposMedida() {
        ...
        int[] pesoMedidaIzq = {5004, 5005, 5006, 5007, 5026};//modificacion codigo 500454 
        int[] fuerzaMedidaDer = {5008, 5009, 5010, 5011, 5027};//modificacion codigo 500854 
        // arreglo original: modificado int[] fuerzaMedidaIzq = {5012, 5013, 5014, 5015, 5028}; 
        int[] fuerzaMedidaIzq = {5012, 5013, 5014, 5015, 5028};//modificacion codigo 501254 
    ...
    /* private void calcularEficacia() {
        ...
        System.out.println("---F.Izq: " + fuerzaIzquierda.set(0, 0.0));

        System.out.println(":: Calculando Sumatoria de Pesos:");
        System.out.println("tamanio de peso izq :" + pesoIzquierdo.size() );
        System.out.println("tamanio de peso der :" + pesoDerecho.size());
        System.out.println("tamanio de fuerza izq :" + fuerzaIzquierda.size());
        System.out.println("tamanio de peso izq :" + fuerzaDerecha.size());
        ...
        for (int i = 0; i < fuerzaDerecha.size(); i++) 
        {
            ...
            System.out.println("fuerzaDe:" + fuerzaDe);
            ...
            if (fuerzaDerecha.size() > 0 && fuerzaDerecha.get(0) > 0) 
            {
                ...
                System.out.println("sumaFuerzas:" + sumaFuerzas);
        ...
        for (int i = 0; i < fuerzaDerechaAux.size(); i++) 
        {
            System.out.println("array fuerzaIzquierdaAux: " + fuerzaIzquierdaAux);
...
//                            int dato = JOptionPane.showOptionDialog(null, "<html><div><center><img src='file:images/flag-red-icon.png' alt='algo'/><h2 style='font-family: \"Open Sans Condensed Light\"; color:#069'>Falla en el proceso</h2><hr/><p align='justify' style='font-family: 'Open Sans Condensed Light'; font-size: 15px; '>Eficacia superior a el 100%, debe repetir la prueba</p><hr/><br/></center></div></html>", "FALLA EN EL PROCESO", 0, -1, null, choices, choices[0]);
        ...
        if (sumaFuerzas > 0) 
        {
            FrenoMotoCarro.eficacia = ((sumaFuerzas) / (sumaPesos)) * 100.0;
        } else {
            FrenoMotoCarro.eficacia = 1;
        }
        
        System.out.println("_|_ Valor Eficacia Frenos " + FrenoMotoCarro.eficacia);
        System.out.println("Valor calculado eficacia FRENOS sin recorte decimal"+FrenoMotoCarro.eficacia);
