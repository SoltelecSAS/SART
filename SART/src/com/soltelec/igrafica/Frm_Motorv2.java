...
//        cargarConfigLabrado();
    ...
    /**
     * Metodo que permite cargar los valores de permisibles para cuando se
     * presenta profundidad de labrado para livianos
     */
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        if (jCheckBox5.isSelected()) {
            persistir = insertarDefectosDb(statement, 10104, idPrueba);
        }
    ...
    //JFM-----------------------------------------------------------
    /**
     * Metodo para consultar las medidas de la llanta de repuesto y asi mismo en
     * el formulario muestre el mensaje en caso de que se deba insertar el
     * defecto
     *
     * @autor Felipe Martin
     * @param permsible
    ...
    private boolean validarMedidasLabradoRepuesto(double permisible, int idPrueba) {
        ...
        try {
            ...
            List<Double> listaDeVariables = new ArrayList<>();
            for (int i = 0; i < listLabradoRepuesto.size(); i++) {
                Double variableActual = listLabradoRepuesto.get(i);
                listaDeVariables.add(variableActual);
            }
            System.out.println("medidas" + listaDeVariables);
            if (listaDeVariables.isEmpty()) {
                flag = true;
                return flag;
            } else {
...
//                }
//            }
                if (listLabradoRepuesto.isEmpty()) {
                    flag = false;
                    return flag;
                } else {
                    for (int i = 0; i < listLabradoRepuesto.size(); i++) {
    ...
    //JFM-----------------------------------------------------------
    /**
     * Metodo para colsultar las medidas de profundida de labrado por medio de
