...
public class LabradoPresionLiviano extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        chkRespuesto1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkRespuesto1ActionPerformed(evt);
            }
        });
        ...
        chkRespuesto1P.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkRespuesto1PActionPerformed(evt);
            }
        });
    ...
    private void chkRespuesto1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkRespuesto1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkRespuesto1ActionPerformed

    private void chkRespuesto1PActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkRespuesto1PActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkRespuesto1PActionPerformed
    ...
    private boolean ValidarNumeros() {
        ...
        if (!txtEje1Izquierda.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA IZQUIERDA DE EJE 1", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
        ...
        if (!txtEje1Derecha.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA DERECHA DE EJE 1", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje1Derecha.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (!txtEje2Izquierda.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA IZQUIERDA DE EJE 2", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje2Izquierda.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkEje2Izquierda.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA INTERNA 1", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje2IzquierdaInt.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (!txtEje2Derecha.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA DERECHA DE EJE 2", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje2Derecha.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkEje2Derecha.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA INTERNA 2", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje2DerechaInt.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (!txtEje3Izquierda.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA IZQUIERDA DE EJE 3", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje3Izquierda.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkEje3Izquierda.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA INTERNA 3", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje3IzquierdaInt.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (!txtEje3Derecha.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA DERECHA DE EJE 3", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje3Derecha.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkEje3Derecha.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA INTERNA 4", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje3DerechaInt.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (!txtEje4Izquierda.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA IZQUIERDA DE EJE 4", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje4Izquierda.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkEje4Izquierda.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA INTERNA 5", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje4IzquierdaInt.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (!txtEje4Derecha.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA DERECHA DE EJE 4", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje4Derecha.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkEje4Derecha.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA INTERNA 6", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje4DerechaInt.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (!txtEje5Izquierda.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA IZQUIERDA DE EJE 5", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje5Izquierda.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkEje5Izquierda.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA INTERNA 7", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje5IzquierdaInt.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (!txtEje5Derecha.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA DERECHA DE EJE 5", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje5Derecha.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkEje5Derecha.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA INTERNA 8", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje5DerechaInt.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkRespuesto1.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA REPUESTO 1", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtRepuesto1.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
                ...
                ValidacionCorrecta = false;///puede ser la solucion cambiando a true en el catch
                System.out.println("19");
            }

        } else {
            ValidacionCorrecta = true;
            //txtRepuesto1.setBorder(BorderFactory.createLineBorder(Color.gray, 1));
        }
        if (chkRespuesto2.isSelected()) {
            try {
                valor = Double.valueOf(txtRepuesto2.getText());
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA REPUESTO 2", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtRepuesto2.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkRespuesto3.isSelected()) {
            try {
                ...
                if (valor > 20) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA REPUESTO 3", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtRepuesto3.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
        ...
        if (chkRespuesto1P.isSelected()) {
            try {
                ...
                ValidacionCorrecta = false;///posible solucion cambio a true
                System.out.println("40");
            }

        } else {
            System.out.println("---------------------------------------------------boton repuesto en presion");
