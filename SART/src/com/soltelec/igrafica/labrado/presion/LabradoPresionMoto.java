    ...
    private boolean ValidarNumeros() {
        ...
        if (!txtEje1Izquierda.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 15) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA 1", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
        ...
        if (!txtEje2Izquierda.getText().equalsIgnoreCase("")) {
            try {
                ...
                if (valor > 15) {
                    JOptionPane.showMessageDialog(this, "VALIDAR MEDIDAS DE LLANTA 2", "SART 1.7.2", JOptionPane.ERROR_MESSAGE);
                    ValidacionCorrecta = false;
                }
                txtEje2Izquierda.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
