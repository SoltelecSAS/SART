 ...
 * @author hansolo
 */
public class LuzBaja extends javax.swing.JComponent implements java.awt.event.ComponentListener, ActionListener {
    ...
    public LuzBaja() {
        ...
        //color = new Color(0x07,0x88,0x4f);
    ...
    private void dibujarContenido(Graphics2D g2, int d) {
        ...
        g2.setColor(color);
        int diametro = d;
        g2.drawArc(diametro / 4, diametro / 3, diametro / 2, diametro / 3, 90, 180);//arco
        g2.drawLine(diametro / 2, diametro / 3, diametro / 2, diametro * 2 / 3);//linea vertical
        g2.drawLine(diametro * 3 / 5, diametro * 10 / 24, diametro * 7 / 10, diametro * 11 / 24);//
        g2.drawLine(diametro * 3 / 5, diametro * 12 / 24, diametro * 7 / 10, diametro * 13 / 24);
        g2.drawLine(diametro * 3 / 5, diametro * 14 / 24, diametro * 7 / 10, diametro * 15 / 24);
