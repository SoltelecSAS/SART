 ...
 */
public class FrmComentarioDiesel extends javax.swing.JDialog {
    ...
    public FrmComentarioDiesel(Window owner, Long idPrueba, ModalityType modalityType,String msgRechazo, long idUsuario, String funcion) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (funcion.equalsIgnoreCase("aborto")) {
                String statement = "UPDATE pruebas SET Finalizada = 'N',Aprobada='N',Abortada='Y',Comentario_aborto=?,observaciones=? , usuario_for = ?,serialEquipo = ? WHERE pruebas.Id_Pruebas = ?;";
               ...
               // instruccion.setString(2, motivoAborto.concat(" obs:").concat(txtComent.getText()));
                ...
                String statement = "UPDATE pruebas SET observaciones=? WHERE pruebas.Id_Pruebas = ?";
                java.sql.PreparedStatement instruccion = conexion.prepareStatement(statement);                
                instruccion.setString(1,"Condiciones Anormales Encotradas .-"+ msgRechazo.toString().concat(" obs:").concat(txtComent.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmComentarioDiesel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Logger.getLogger(FrmComentarioDiesel.class.getName()).log(Level.SEVERE, null, ex);
                }
