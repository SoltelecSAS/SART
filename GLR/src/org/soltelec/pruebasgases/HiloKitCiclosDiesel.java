...
/**
 *Clase para realizar la prueba diesel
 * usando opacimetro y kit de revoluciones capelec
 * @author Usuario
 */
...
//                    while( (rpmKit < velRalenti-100 || rpmKit > velRalenti+100) && contadorTemporizacion < T_RALENTI && blinker != null){
                    while( (rpmKit < velRalenti-100 || rpmKit > velRalenti+100) && contadorTemporizacion < T_ANTES_ACELERAR && blinker != null){
                        Thread.sleep(100);
                    ...
                    //en los ultimos 3 segundos se da la indicacion del 
                    contadorTemporizacion = 0;
                   ...
                   rpmKit = consumidorCapelec.getRpm();
                   contadorTemporizacion = 0;
                   while(contadorTemporizacion <= 11){//no importa mucho la velocidad
                       dialogo.getRadialTacometro().setValue(rpmKit);
                       dialogo.getDisplayTiempo().setLcdValue(contadorTemporizacion);
                       rpmKit = consumidorCapelec.getRpm();
                       Thread.sleep(10);
