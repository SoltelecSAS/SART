 ...
 * @author Usuario
 */
public class PanelLuxometro extends JPanel {
   ...
   //private Led ledLuzBajaDerecha, ledLuzAltaDerecha,ledLuzBajaIzquierda,ledLuzAltaIzquierda;
    ...
    public static void main(String args[]){
        ...
        PanelLuxometro panel = new PanelLuxometro();
        app.add(panel);
        app.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        Thread t  = new Thread(new HiloPruebaLuxometro(panel,1));
        t.start();
        app.setVisible(true);
    }
